    ...
    menuItems: [
      {
        ...
        label: 'Dashboard',
        route: '#',
        children: [{ label: 'User', route: '/' },{ label: 'Order', route: '/' }]
      },
      {
        icon: `<svg
                  class="fill-current"
...
<template>
  ...
  >
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
      <router-link to="/">
        <img class="min-w-24 items-center justify-between max-w-44 mt-3 px-6" src="@/assets/images/logo/logo-kongkon.png" alt="Logo" />
        <h2 class="px-6">Admin</h2>
      </router-link>
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
      <!-- Sidebar Menu -->
      <nav class="mt-3 py-4 px-4 lg:mt-4 lg:px-6">
